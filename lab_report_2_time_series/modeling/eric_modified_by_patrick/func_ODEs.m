function dydt = func_ODEs(t,y,inhib,p_mine,EGF_conc,te,tp,conc,conc2)
...
if t>tp
    ...
    % conc2 depends on inhib = [3,5]
    % ie: set third value to fifth column in well layout
    % conc2(3) reduces active EDF 
    conc2(inhib(1))=conc(inhib(1),inhib(2));
end

% ensure EGF has a 'real' value at the start of everything
y(17) = max(EGF_cell,y(17));
zeroIdx = (y < 0);
% ensure we don't have any negative concentrations
y(zeroIdx) = 0;
kinetic_p=p_mine;
