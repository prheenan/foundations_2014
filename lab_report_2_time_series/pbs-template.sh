...
#PBS -m abe
#PBS -M patrick.heenan@colorado.edu

### Optionally set the destination for your program's output
### Specify localhost and an NFS filesystem to prevent file copy errors.
#PBS -e localhost:$HOME/logs/myjobErrorOutput.log
#PBS -o localhost:$HOME/logs/myjobNormalOutut.log
